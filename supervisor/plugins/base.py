...
from ..const import ATTR_IMAGE, ATTR_VERSION, DOCKER_REPO_ORG, DOCKER_REPO_PREFIX
...
class PluginBase(ABC, FileConfiguration, CoreSysAttributes):
    ...
    def image(self) -> str:
        ...
        return f"{DOCKER_REPO_PREFIX}{DOCKER_REPO_ORG}/{self.sys_arch.supervisor}-hassio-{self.slug}"
